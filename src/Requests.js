...
class Requests extends React.Component {
    ...
    getRequests = () => {
        ...
        axios.get('http://ci-backend-new-ci-selfserv.apps.ci.centos.org/requests', { withCredentials: true }
        ).then(res=> {
    ...
    getRequestsByName = () => {
        ...
        axios.get('http://ci-backend-new-ci-selfserv.apps.ci.centos.org/requests',
        {
